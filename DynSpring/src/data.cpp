...
void Data::set_save_number(int const save_number) {
    save_number_ = save_number;
}
...
void Data::set_force(double const force) {
    force_ = force;
}
